...
public class SubActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.sub_sub);
        Toolbar toolbar = findViewById(R.id.tb_sub);
        ...
        recyclerView=(RecyclerView)findViewById(R.id.rv_sub);
        LinearLayoutManager layoutManager=new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        messageAdapter2=new MessageAdapter2(messagesList,SubActivity.this);
            ...
            public void run() {
                try{
                    ...
                    Request request=new Request.Builder()
                            .url("https://wanandroid.com/user_article/list/"+count+"/json")
                            .build();
    ...
    public void getJSON(String jsonData){
        try{
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                String shareUser=first.getString("shareUser");
