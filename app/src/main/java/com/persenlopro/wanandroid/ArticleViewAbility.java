...
public class ArticleViewAbility extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        realId=bundle.getInt("id");
        author=bundle.getString("author");


        //使toolbar与actionbar一致（actionbar已隐藏）
        setTitle("");
        Toolbar toolbar = findViewById(R.id.tb_article);
        ...
        messageAdapter2=new MessageAdapter2(messagesList,ArticleViewAbility.this);
            ...
            public void run() {
                try{
                    ...
                    Request request=new Request.Builder()
                            .url("https://www.wanandroid.com/article/list/"+count+"/json?cid="+realId)
                            .build();
                    ...
                    getJSON(responseData);
                    ...
                    else
                        {
                            OkHttpClient client=new OkHttpClient();
                            Request request=new Request.Builder()
                                    .url("https://wanandroid.com/article/list/"+count+"/json?author="+author)
                                    .build();
                            Response response=client.newCall(request).execute();
                            String responseData=response.body().string();
                            getJSON(responseData);
